...
Then Hashtable passes its elements into an array.
We have two copies of that array, with one we build a max Heap based on their occurence count in the text so that we will find top 5 used words easily, the other copy gets sorted with Merge Sort based on their length so that we can find the median value and it's length.
...
![Screenshot from 2021-02-23 12-30-16](https://user-images.githubusercontent.com/63292060/108832090-b16a1200-75d3-11eb-8306-3664d875cb9d.png)
